...
float[] intersectionWall_qr(float x, float y, float len_x, float len_y) {
...
float[] intersectionWall_pol(float x, float y, float len_x, float len_y) 
{
  float[] dx = new float[3];
  float[] sx = new float[3];
  float[] up = new float[3];
 ...
 */
  ...
  //è sufficiente ci sia una sola collisione
  dx = intersectionLine(vertici_sp[0] - x, vertici_sp[1] - y, vertici_sp[2] - x, vertici_sp[3] - y, 0, 0, len_x, len_y); // v1-v2 -> in basso a sx ---- in basso a dx
  if (dx[0] == 1) { //se ho una collisione a dx la salvo
    wall_collision[0] = 1;
    wall_collision[1] = dx[1];
    wall_collision[2] = dx[2];
  ...
  sx = intersectionLine(vertici_sp[0] -x, vertici_sp[1] -y, vertici_sp[4] -x, vertici_sp[5] - y, 0, 0, len_x, len_y); //v1-v3 -> in basso a sx --- in alto a sx
  if (sx[0]==1) {
    wall_collision[0] = 1;
    wall_collision[1] = sx[1];
    wall_collision[2] = sx[2];
  ...
  up = intersectionLine(vertici_sp[6] -x, vertici_sp[7] -y, vertici_sp[4] -x, vertici_sp[5] - y, 0, 0, len_x, len_y); //v4-v3 -> in alto a dx --- in alto a sx
  if (up[0]==1) {
    wall_collision[0] = 1;
    wall_collision[1] = up[1];
    wall_collision[2] = up[2];
  ...
  down = intersectionLine(vertici_sp[6] -x, vertici_sp[7] -y, vertici_sp[2] -x, vertici_sp[3] - y, 0, 0, len_x, len_y); //v4-v2 -> in alto a dx ---- in basso a dx
  if (down[0]==1) {
    wall_collision[0] = 1;
    wall_collision[1] = down[1];
    wall_collision[2] = down[2];
...
float[] intersectionWall_3v(float x, float y, float len_x, float len_y) 
{
  float[] dx = new float[3];
  float[] sx = new float[3];
  float[] up = new float[3];
 ...
 */
  ...
  //è sufficiente ci sia una sola collisione
  dx = intersectionLine(vertici_sp[0] - x, vertici_sp[1] - y, vertici_sp[2] - x, vertici_sp[3] - y, 0, 0, len_x, len_y); // v1-v2 
  if (dx[0] == 1) { //se ho una collisione a dx la salvo
    wall_collision[0] = 1;
    wall_collision[1] = dx[1];
    wall_collision[2] = dx[2];
  ...
  sx = intersectionLine(vertici_sp[0] -x, vertici_sp[1] -y, vertici_sp[4] -x, vertici_sp[5] - y, 0, 0, len_x, len_y); //v1-v3 
  if (sx[0]==1) {
    wall_collision[0] = 1;
    wall_collision[1] = sx[1];
    wall_collision[2] = sx[2];
  ...
  */
  ...
  down = intersectionLine(vertici_sp[4] -x, vertici_sp[5] -y, vertici_sp[2] -x, vertici_sp[3] - y, 0, 0, len_x, len_y); //v3-v2 
  if (down[0]==1) {
    wall_collision[0] = 1;
    wall_collision[1] = down[1];
    wall_collision[2] = down[2];
